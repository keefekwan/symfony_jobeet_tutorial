<?php
// src/KK/JobeetBundle/Controller/AffiliateAdminController.php
...
class AffiliateAdminController extends Controller
{
        ...
        try {
            foreach($selectedModels as $selectedModel) {
                ...
                $message = \Swift_Message::newInstance()
                    ...
                    ->setFrom('kcshuffle77@gmail.com')
                    ->setTo('webdev.kkwan@gmail.com')
                    ->setBody($this->renderView('KKJobeetBundle:Affiliate:email.txt.twig', array(
    ...
    public function activateAction($id)
    {
        ...
        $em = $this->getDoctrine()
            ->getManager();
        $affiliate = $em->getRepository('KKJobeetBundle:Affiliate')
            ->findOneById($id);
        ...
        try {
            ...
            $message = \Swift_Message::newInstance()
                ->setSubject('Jobeet affilate token')
                ->setFrom('kcshuffle77@gmail.com')
                ->setTo('webdev.kkwan@gmail.com')
                ->setBody($this->renderView('KKJobeetBundle:Affiliate:email.txt.twig', array(
    ...
    public function deactivateAction($id)
    {
        ...
        $affiliate = $em->getRepository('KKJobeetBundle:Affiliate')->findOneById($id);

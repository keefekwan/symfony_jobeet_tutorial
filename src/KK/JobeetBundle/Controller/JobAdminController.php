<?php
// src/KK/JobeetBundle/Controller/JobAdminController.php
...
class JobAdminController extends Controller
{
    public function batchActionExtend(ProxyQueryInterface $selectedModelQuery)
    {
        ...
        $this->get('session')->getFlashBag()
            ->add('sonata_flash_success', sprintf('The selected jobs validity has been extended until %s . ', date('m/d/Y', time() + 86400 * 30)));
    ...
    public function batchActionDeleteNeverActivated()
    {
        ...
        $nb = $em->getRepository('KKJobeetBundle:Job')->cleanup(60);
